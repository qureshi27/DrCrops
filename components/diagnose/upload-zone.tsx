    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <h3 className="mt-5 text-lg font-semibold">
          {busy ? "Analysing leaf…" : "Drop a leaf photo or use camera"}
        </h3>
        ...
        <div className="mt-6 flex flex-wrap gap-3 justify-center">
          <button
            ...
            className="rounded-pill px-5 py-2.5 text-sm font-medium bg-gradient-to-r from-accent to-accent-glow text-black shadow-glow-cyan hover:brightness-110 transition inline-flex items-center gap-2"
          >
          ...
          <button
            ...
            className="rounded-pill px-5 py-2.5 text-sm border border-line text-ink hover:bg-white/5 transition inline-flex items-center gap-2"
          >
